...
from dataset_custom import get_dataset_list, CustomCodeDataset, CustomExpressiveCodeDataset, mel_spectrogram
...
def train(a, h):
    ...
    trainset = CustomExpressiveCodeDataset(training_list, h.segment_size, h.code_hop_size, h.n_fft, h.num_mels, h.hop_size,
    ...
    validset = CustomExpressiveCodeDataset(validation_list, h.segment_size, h.code_hop_size, h.n_fft, h.num_mels, h.hop_size,
